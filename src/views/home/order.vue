    ...
    <div class="search-head">
      <div class="fl drops">
        <el-select class="yhc-select"
          ...
          <el-option v-for="x in cost.receiveStatus"
                     :key="x.value"
                     :label="x.name"
                     :value="x.value">
          </el-option>
          ...
          <li class="list-card"
            ...
            <div class="list-card-head">
              ...
              <span class="status-font"
                    :class='{"1":"btn-orange","2":"btn-blue_","3":"btn-blue_","4":"btn-blue_","5":"btn-blue","6":"btn-red","7":"btn-gray","8":"btn-red","9":"btn-red"}[x.status]'>{{x.status | yhc_status}}</span>
            </div>
            ...
            <div class="content">
              <p><img src="@/assets/img/fahuo.png"
                     alt=""
